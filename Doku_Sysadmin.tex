...
%Die Steuerung des Roboters hängt vom fehlerfreien und sauberen Steuerungscode ab. Falls nötig, müsste man Veränderungen am bestehenden Code durchführen.
...
Der Bootvorgang des Raspbian soll so konfiguriert werden,   %TODO
