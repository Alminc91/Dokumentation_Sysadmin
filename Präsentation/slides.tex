...
\begin{frame}
\centerline{\includegraphics[width=13cm]{pics/ros_equation.png}}
\end{frame}
...
\begin{frame}
\centerline{\includegraphics[width=6cm]{pics/groovy.jpg}}
\centerline{\includegraphics[width=6cm]{pics/frage.png}}
\end{frame}


\begin{frame}
\centerline{\includegraphics[width=2cm]{pics/groovy.jpg}}
\centerline{\includegraphics[width=3.5cm]{pics/frage.png}}
\end{frame}
