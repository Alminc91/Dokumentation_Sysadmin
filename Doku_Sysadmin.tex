...
%Modulares und flexibles Netzwerk, Repositories sollen leicht in Projekte eingebunden werden,  Beliebige Linux-Systeme einbinden
Ein Modulares und flexibles Netzwerk, sowie das einfache Einbinden von Repositories ist durch ROS in Kombination mit Catkin gegeben. Die Unterstützung beliebiger Linuxsysteme erfolgt ebenfalls durch ROS. Diese Features müssen allerding zuvor aktiviert werden.
%TODO umschreiben!
